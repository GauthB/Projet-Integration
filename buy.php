...
<div class="site-wrap">
    ...
    <div class="site-section site-hero inner">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-10">
                    <span class="d-block mb-3 caption">L'obtenir!</span>
                    <h1 class="d-block mb-4">Louer</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 mb-5 mb-lg-0"  data-aos="fade-up" data-aos-delay="200">
                    <div class="pricing border-secondary text-center">
                        ...
                        <ul class="list-unstyled mb-5">
                            <li>Prix par dispositif</li>
                            <li>Un local</li>
                            <li>...</li>
                            <li>...</li>
                            <li>....</li>
                        </ul>
                        <div><a href="#" class="btn btn-secondary px-4 py-2">Commander</a></div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="300">
                    <div class="pricing border-primary text-center">
                        <h2>Un évènement</h2>
                        <div class="amount"><sup>€</sup><span class="number">250</span> </div>
                        <ul class="list-unstyled mb-5">
                            <li>Prix par dispositif</li>
                            <li>Une scène</li>
                            <li>...</li>
                        ...
                        <div><a href="#" class="btn btn-primary px-4 py-2">Commander</a></div>
                    </div>
                </div>

                <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="400">
                    <div class="pricing border-secondary text-center">
                        <h2>Plusieurs scènes</h2>
                        <div class="amount"><sup>€</sup><span class="number">200</span> </div>
                        <ul class="list-unstyled mb-5">
                            <li>Prix par dispositif</li>
                            <li>Dans un festival</li>
                            <li>...</li>
                            <li>...</li>
                            <li>...</li>
                        </ul>
            ...
            <div class="slide-one-item home-slider owl-carousel">
              ...
              <div class="row justify-content-center">
                ...
                <div class="testimony text-center col-md-5">
                  ...
                  <blockquote>
                    <p>Texte Exemple 1</p>
                    <p class="author">&mdash; Exemple 1</p>
                  </blockquote>
                </div>
              </div>
