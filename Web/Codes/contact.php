    ...
    else
    {
        ...
        elseif(!empty($envoi))
        {
            ...
            if(mail($destinataire,$objet,$message,$headers))
            {
                ...
                echo'<p>Un problème est survenu durant l\'envoi du mail. Vous pouvez toujours nous contacter via notre adresse  <a href="mailto:peopleflux@gmail.com">mail</a></p>';
        }
        else
            echo'<p>Une condition innatendue est survenue lors de l\'exécution du script. Vous pouvez toujours nous contacter via notre adresse  <a href="mailto:peopleflux@gmail.com">mail</a></p> ';
    }
}
else
{
