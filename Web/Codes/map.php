...
<div class="container">
    ...
    <ul>
        ...
        ?>
        <li><input classe="btnMap" type="button" value="24 Heures vélo" id="24hvelo"></li>
        <li><input classe="btnMap" type="button" value="Welcome Spring! Festival 2019" id="wsp"></li>
    </ul>

    <?php foreach ($eventNames as $eventName): ?>
        <div id="title<?=$eventName['id_event']?>" style='display:none;'>
            <span class="d-block mb-3 caption" data-aos="fade-up" style="text-align: center;text-decoration: underline;"><i><?=$eventName['event_name']?></i></span>
        </div>
    <?php endforeach;?>
