...
<head>
    ...
    <link rel="icon" type="images/LogoSmall.png" href="logo.png" />
...
<div class="site-wrap">
    ...
    <div class="site-section site-hero">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-10">
                    <span class="d-block mb-3 caption" data-aos="fade-up" data-aos-delay="100">Projet d'Intégration</span>
                    <h1 class="d-block mb-4" data-aos="fade-up" data-aos-delay="200">People Flux</h1>
                    <span class="d-block mb-5 caption" data-aos="fade-up" data-aos-delay="300">Janvier 2020, EPHEC, Louvain-la-Neuve</span>
                    <a href="lieux.php" class="btn-custom" data-aos="fade-up" data-aos-delay="400"><span>Carte en direct</span></a>
                </div>
            </div>
        </div>
    </div>
